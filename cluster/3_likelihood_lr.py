...
if __name__ == "__main__":
    ...
    from Francesco_PDE import *
    #import matplotlib.pyplot as plt
    '''
    pdeObj_1 = SIR_PDEroutine(rho, CIdist=inf_distr, CIdistParms=[1],\
                              recovDist=rec_haz, recovDistParms=[6,1.8],\
                                  nTgrid=1000, nUgrid=1000, T=2)
    X,Y=pdeObj_1.finDiffUpdate()
            
    '''
    import time
    start = time.time()
    from Francesco_Likelihood import log_likelihood_models
